...
const DoctorPage = () => {
    ...
    const handleDoctorClick = (doctor) => {
        navigate(`/schedule/calendar?doctor_id=${doctor.id}&doctor_name=${encodeURIComponent(doctor.full_name)}&spec=${encodeURIComponent(specialization)}`);
    };
    ...
    return (
        <div className="booking-page">
            <div className="container">
                ...
                <ScheduleBreadcrumbs currentStep={1} selectedData={selectedData} />

                <div className="booking-layout">
                    <ScheduleSidebar currentStep={1} selectedData={selectedData} />
